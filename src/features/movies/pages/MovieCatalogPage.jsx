  ...
  return (
    <>
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <h1 className="mb-6 text-3xl font-bold sm:text-4xl">{pageTitle}</h1>
          ...
          <>
            ...
            {isSearching && searchLimitReached && movies.length > 0 && (
              <p className="mt-6 text-zinc-400" role="status">
                Showing matches from the first 5 result pages. Use a more
                specific title to narrow the search.
              </p>
            )}
